...
import { finger, vector } from '../../assets';
    ...
    <View>
        <ScrollView style={{ backgroundColor: "#3531B3", height: '100%' }}>
            ...
            <View style={{ alignItems: 'center', justifyContent: 'center' }}>
                <Image source={finger} style={styles.head2} />
            </View>
            <View>
                ...
                <View style={{ paddingLeft: normalize(50), paddingRight: normalize(50) }}>
                    <Text style={{ textAlign: 'center', fontFamily: "Nunito-Regular", color: "white" }}>
                        Turn on fingerprint authentication for faster login and transactions, or manage
                        later in
                    </Text>
            ...
            <View>
                <View style={{ alignItems: 'center', justifyContent: 'center', marginTop: normalize(20), paddingBottom: normalize(30) }}>
                    <TouchableOpacity onPress={() => props.navigation.navigate("bio-face")} style={{ backgroundColor: "#FFB70A", width: normalize(250), height: normalize(50), borderRadius: 25, alignItems: "center", justifyContent: "center" }}>
                        <Text style={{ color: "#3531B3", textAlign: "center", fontFamily: "Nunito-Bold", fontWeight: 'bold', lineHeight:21 }}>ACTIVATE FINGERPRINT</Text>
                    </TouchableOpacity>
