...
import { arrow, biometric, header2, lockey, vector, vector2 } from '../../assets';
            ...
            <ScrollView style={{ backgroundColor: "#3531B3", height: "100%" }}>
                ...
                <View>
                        ...
                        <View>
                            ...
                            <View style={{ justifyContent: "center", alignItems: "center" }}>
                                <View style={{ width: normalize(330), paddingLeft: normalize(10), height: normalize(50), borderRadius: 5, backgroundColor: "#221F7A", marginRight: normalize(20) }}>
                                    <View style={{ flexDirection: "row" }}>
                                        <Text style={{ color: "white", fontSize: normalize(24), marginTop: normalize(10) }}>+62</Text>
                                        <TextInput style={{ width: normalize(300), color: "white", fontSize: normalize(24), fontWeight: "bold" }} keyboardType={"number-pad"} />
                                    </View>
                                </View>
                                ...
                                <View style={{ marginTop: normalize(50) }}>
                                    <View style={{ width: normalize(330), paddingLeft: normalize(10), height: normalize(50), borderRadius: 5, backgroundColor: "#221F7A", marginRight: normalize(20) }}>
                                        <View style={{ flexDirection: "row" }}>
                                            <TextInput secureTextEntry style={{ width: normalize(270), color: "white", fontSize: normalize(20) }} />
                    ...
                    <View style={{ marginTop: normalize(100), justifyContent: "center", alignItems: "center", paddingBottom:normalize(20) }}>
                        <TouchableOpacity onPress={() => { pass ? props.navigation.navigate("login") : setModalVisible(true) }} style={{ backgroundColor: "#FFB70A", width: normalize(250), height: normalize(50), borderRadius: 25, alignItems: "center", justifyContent: "center" }}>
