...
import { finger, fingerface, vector } from '../../assets';

const FingerFace = (props) => (
    <View>
        <ScrollView style={{ backgroundColor: "#3531B3", height: '100%' }}>
            ...
            <View style={{ alignItems: 'center', justifyContent: 'center' }}>
                <Image source={fingerface} style={styles.head2} />
            </View>
            <View>
                <Text style={styles.text1}>Activate Fingerprint/Face ID</Text>
                <View style={{ paddingLeft: normalize(50), paddingRight: normalize(50) }}>
                    <Text style={{ textAlign: 'center', fontFamily: "Nunito-Regular", color: "white" }}>
                        Turn on fingerprint/face ID authentication for faster login and transactions, or manage
                        later in
                    </Text>
            ...
            <View>
                <View style={{ alignItems: 'center', justifyContent: 'center', marginTop: normalize(20), paddingBottom: normalize(30) }}>
                    <TouchableOpacity onPress={() => props.navigation.navigate("active-finger")} style={{ backgroundColor: "#FFB70A", width: normalize(250), height: normalize(50), borderRadius: 25, alignItems: "center", justifyContent: "center" }}>
